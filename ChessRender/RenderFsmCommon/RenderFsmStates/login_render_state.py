...
class FsmStateLogin(ScreenState):
    def __init__(self, process_login, render_fsm):
        ...
        self.screen_atributes.screen_texts["scrtext:Login"] = ScreenTextFsm("Login:   ", (-0.9, 0.7))
        self.screen_atributes.screen_texts["scrtext:Password"] = ScreenTextFsm("Password:", (-0.9, 0.3))
