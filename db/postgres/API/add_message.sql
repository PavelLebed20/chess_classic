...
BEGIN
  ...
  BEGIN
    ...
    update chess.messages set data = p_data, request_id = -1, send_time = null, add_time = NOW()
    ...
    -- otherwise add new
    INSERT INTO chess.messages(data, user_id, message_type_id, priority,
                               resend_time, resend_stop_time) VALUES (p_data,
                                                                     p_user_id,
                                                                     v_message_type_id,
